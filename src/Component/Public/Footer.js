            ...
            >
                <Grid container spacing={5} sx={{ borderBottom: '1px solid #ccc', pb: 5 }}>
                    ...
                    <Grid item xs={12} lg={4} sm={12} md={6}>
                        ...
                        <Typography variant="body2" py={2}>
                            Spirale Infosoft Pvt. Ltd. is one of the most trusted and reliable software development companies based in India. We provide our finest services in website designing and development. We have dedicated teams of experts and developers to help you in maintenance and digital marketing services as well.
                        </Typography>
                        <Stack
                            direction="row"
                            alignItems="center"
                ...
                <Box>
                    <Typography variant="body2" py={2} textAlign="center">
                        Copyright @ 2025 Spirale Infosoft Pvt. Ltd.(Spirale Infosoft Pvt. Ltd.) All Rights Reserved by{' '}
                        <span
                            style={{ color: '#E99f2B', textDecoration: 'underline', cursor: 'pointer' }}
                            onClick={handleHome}
                        >
                            Spirale Infosoft Pvt. Ltd.
                        </span>
                    </Typography>
                </Box>
            </Box>
