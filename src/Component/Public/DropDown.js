...
// Fix: Convert active prop to string when passing to DOM
const StyledButton = styled(Button, {
    shouldForwardProp: (prop) => prop !== 'active', // Don't forward 'active' to DOM
})(({ active }) => ({
    textTransform: "none",
    display: "flex",
        ...
        menuItems.map((item, index) => (
            <Dropdown key={index}>
                <StyledButton
                    ...
                    // Remove the boolean attribute from being passed to DOM
                    component="a"
                >
                    {item.icon && (
