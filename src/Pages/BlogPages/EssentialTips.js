        ...
        <div>
            <Box sx={{ px: { xs: 2, md: 14 }, py: 6 }}>
                ...
                <Typography variant='h5'>
                    ...
                    <a href="https://Spirale Infosoft Pvt. Ltd..in" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'underline', color: 'blue' }}>
                        <span>Spirale Infosoft Pvt. Ltd.</span>
                    </a>{' '}
