...
const content2 = [
    ...
    {
        title: "Role of Spirale Infosoft in Mobile Application Development",
        description: ["At Spirale Infosoft, we specialize in delivering cutting-edge mobile applications tailored to your business needs. Our expertise spans both iOS app development and Android app development, ensuring that your app reaches a broad audience. Here’s what sets us apart:"]
    },
    {
...
const typesData3 = [
...

    {
        ...
        description: "At Spirale Infosoft, innovation is at the core of what we do. We integrate advanced features and emerging technologies like AI, AR/VR, and IoT to make your app future-ready."
    },
];
            ...
            <Box sx={{ px: { xs: 2, md: 14 }, py: 6 }}>
                ...
                {content2.map((content, index) => (
                    <Box key={index} sx={{ mt: 5 }}>
                        ...
                        {content.title === "Role of Spirale Infosoft in Mobile Application Development" && (
                            <Box component="ul" sx={{ p: 0, m: 0, listStyleType: 'none' }}>
