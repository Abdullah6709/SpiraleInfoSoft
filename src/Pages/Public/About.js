                ...
                <Grid container spacing={4} sx={{ py: { xs: 2, md: 3 } }}>
                    ...
                    <Grid item sm={6} xs={12}>
                        <Stack spacing={1}>
                            ...
                            <Typography variant='body2'>
                                Our team at Spirale Infosoft Pvt. Ltd. believes in getting better and better at the work in order to provide customer satisfaction and a delightful experience of working with us. We always keep searching for that mastery and perfection so that we can benefit our clients most with our services.
                            </Typography>
                            <Typography variant='body2'>
                    ...
                    <Grid item sm={6} xs={12} my={1}>
                        <Stack spacing={1}>
                            ...
                            <Typography variant='body2'>
                                Spirale Infosoft Pvt. Ltd. is a leading software development and service providing company since 2016, offering a wide range of software development and maintenance services across the globe.
                            </Typography>
                            <Typography variant='body2'>
