            ...
            <Grid container spacing={5} sx={{ py: { xs: 2, md: 3, lg: 5 }, px: { xs: 2, lg: 15, md: 10 }, }}>
                <Grid item xs={12} md={6}>
                    ...
                    <Typography variant="h6" lineHeight={1.5}>
                        At Spirale Infosoft Pvt. Ltd., we believe that great things are built by great teams. If you are passionate about
            ...
            >
                ...
                <Grid item xs={12} lg={6}>
                    <Typography variant="h4" fontWeight="bold" mb={2}>
                        Journey at Spirale Infosoft Pvt. Ltd.
                    </Typography>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} md={6}>
                        ...
                        <Typography variant='h5' lineHeight={1.5}>
                            At Spirale Infosoft Pvt. Ltd., we believe in nurturing both your professional journey and personal well-being. Our comprehensive package of perks and benefits is designed to enhance your work-life balance, foster growth, and make your time with us truly fulfilling.
                        </Typography>
                    </Grid>
