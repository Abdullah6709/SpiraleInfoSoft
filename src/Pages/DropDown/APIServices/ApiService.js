...
const ApiService = () => {
    ...
    const content = {
        ...
        description: [
            "Spirale Infosoft Pvt. Ltd. is the leading and most trusted software development company in Delhi NCR. We provide API development and integration services to extend the seamless functionality between the application and the other third party systems and devices.",
