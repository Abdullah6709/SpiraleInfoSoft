...
const CrossPlateformApp = () => {
    ...
    const content = {
        ...
        description: [
            "Spirale Infosoft Pvt. Ltd. is a well-known web development company, based in Noida. Our priority is to provide a great customer experience to our clients.",
    ...
    const content2 = {
        title: "Why choose Spirale Infosoft Pvt. Ltd. for the Cross Plateform Development Services ?",
        description: [
