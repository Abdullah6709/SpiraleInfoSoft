...
const AppDevlop = () => {
    ...
    const content = {
        ...
        description: [
            " Spirale Infosoft Pvt. Ltd. is a well organized and an emerging App development company, based in Noida. ",
    ...
    const content2 = {
        title: "Why choose Spirale Infosoft Pvt. Ltd. for App Development Services ?",
        description: [
