...
const Php = () => {
    ...
    const content = {
        ...
        description: [
            "Spirale Infosoft Pvt. Ltd. is a PHP Development Company, based in Noida. We provide php development services that are very cost effective.You can hire developers, having great experience and expertise in the given field.",
    ...
    const content2 = {
        title: "Why choose Spirale Infosoft Pvt. Ltd. for the Web Development Services ?",
        description: [
