...
const CmsDevelop = () => {
    ...
    const content = {
        ...
        description: [
            "Spirale Infosoft Pvt. Ltd. is one of the leading software development companies, based in Noida. We provide best CMS development services and also have a team of dedicated developers that actually cares about customer satisfaction and matching their expectations.",
