...
const Ecommers = () => {
    ...
    const content = {
        ...
        description: [
            "Spirale Infosoft Pvt. Ltd. is an emerging software development and maintenance company, based in Noida. Our company provides one of the best eCommerce services in Delhi NCR.",
